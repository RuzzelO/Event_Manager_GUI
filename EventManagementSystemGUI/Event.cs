...
namespace EventManagementSystemGUI
{
    public class Event
    {
        ...
        public int getEventDate() { return eventDate.getDay(); }
        ...
        public bool addAttendee(Customer c)
        {
            ...
            {
                results = c.getId().CompareTo(attendeeList[x].getId());
                if (results == 0)
                {
                    return false;
                }
        ...
        public bool checkValidC(Customer c)
        {
            if (numAttendees > maxAttendees) { return false; }
            attendeeList[numAttendees] = c;
            numAttendees++;
        ...
        public bool removeAttendee(int custId)
        {
            ...
            attendeeList[loc].removeBooking();
            numAttendees--;
            return true;
        }
